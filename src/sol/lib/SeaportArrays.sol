...
library SeaportArrays {
    ...
    function Orders(Order memory a, Order memory b)
        internal
        pure
    ...
    function Orders(Order memory a, Order memory b, Order memory c)
        internal
        pure
        returns (Order[] memory)
    {
    ...
    function AdvancedOrders(AdvancedOrder memory a)
        internal
        pure
    ...
    function OrderComponentsArray(OrderComponents memory a)
        internal
        pure
    ...
    function OrderParametersArray(OrderParameters memory a)
        internal
        pure
    ...
    function OfferItems(OfferItem memory a)
        internal
        pure
    ...
    function OfferItems(OfferItem memory a, OfferItem memory b)
        internal
        pure
        returns (OfferItem[] memory)
    {
    ...
    function ConsiderationItems(ConsiderationItem memory a)
        internal
        pure
    ...
    function SpentItems(SpentItem memory a)
        internal
        pure
    ...
    function SpentItems(SpentItem memory a, SpentItem memory b)
        internal
        pure
        returns (SpentItem[] memory)
    {
    ...
    function ReceivedItems(ReceivedItem memory a)
        internal
        pure
    ...
    function CriteriaResolvers(CriteriaResolver memory a)
        internal
        pure
    ...
    function AdditionalRecipients(AdditionalRecipient memory a)
        internal
        pure
